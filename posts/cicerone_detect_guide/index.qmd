...
server <- function(input, output, session) {
  observeEvent(input$start, {
    ...
    bslib::accordion_panel_open(id = "your-accordion-id", open = TRUE)
    guide$init()$start()
  })
}
```
...
```r
  observeEvent(input$cicerone_reset, {
    ...
    bslib::accordion_panel_close(id = "your-accordion-id", open = FALSE)
  })
```


[^1]: See on GitHub: [www.github.com/JohnCoene/cicerone](www.github.com/JohnCoene/cicerone) 
[^2]: Emoji designed by OpenMoji – the open-source emoji and icon project. License: CC BY-SA 4.0
